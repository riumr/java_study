...
public class GroupingDemo {
  public static void main(String[] args) {
    ...
    s2=Nation.nations.stream();
    Map<Nation.Type, String> collect2 = s2.collect(Collectors.groupingBy(Nation::getType, Collectors.mapping(Nation::getName, Collectors.joining("#"))));
